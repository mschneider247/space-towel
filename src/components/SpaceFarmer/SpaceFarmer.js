    ...
    <section className="project_section">
      ...
      <div className="btn_div">
        ...
        <p>
          ...
          for your space endevours. Choose between a myriad of different farming supplies to take with you on your adventure. Once you 've decided what supplies to take you are offered arange of destinations around the solar system. Deppending on the destination you will have different rockets at your disposal. The application will take your choices and determine the total weights and costs for the trip and display these all in a final proposal overview. Too expensive? Create as many proposals as you like!
        </p>
      </div>
